...
const New = () => {
  ...
  const [selectedFormalCategory, setSelectedFormalCategory] = useState("All");
  ...
  return (
    <div className="bg-white text-gray-900 font-sans min-h-screen"> 
      <div className="bg-black text-white text-center py-2 overflow-hidden whitespace-nowrap">
        <div className="inline-block animate-marquee min-w-[200%] text-2xl font-bold tracking-widest">
          <span className="mx-6">GET 50% OFF <span className="text-white">✶</span></span>
          <span className="mx-6">GET 50% OFF <span className="text-white">✶</span></span>
          <span className="mx-6">GET 50% OFF <span className="text-white">✶</span></span>
          <span className="mx-6">GET 50% OFF <span className="text-white">✶</span></span>
          <span className="mx-6">GET 50% OFF <span className="text-white">✶</span></span>
      ...
      <div className="max-w-[1280px] mx-auto px-5">
        <section className="mt-20 mb-16">
          <div className="flex flex-col md:flex-row md:justify-between md:items-end gap-5 mb-10">
            ...
            <p className="max-w-md text-gray-600 text-base md:text-lg leading-relaxed">
